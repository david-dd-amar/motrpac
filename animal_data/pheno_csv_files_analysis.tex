...
\CommentTok{# local_path = "/Users/David/Desktop/MoTrPAC/data/pass_1a/dmaqc_pheno/release_10032019/"}
\CommentTok{# system(paste("mkdir",local_path))}
\CommentTok{# bucket = "gs://motrpac-portal-transfer-dmaqc/Official_DMAQC_TRANSFER/20190816_DMAQC_Transfer_PASS_1A.6M_1.00/"}
\CommentTok{# dmaqc_data_dir = paste(local_path,"3-Data_Sets/",sep="")}
\CommentTok{# # dictionary path}
\CommentTok{# dmaqc_dict_dir = paste(local_path,"1-Data_Dictionary/",sep="")}
\CommentTok{# download_bucket_files_to_local_dir(bucket = paste(bucket,"3-Data_Sets/",sep=""),}
\CommentTok{#                                    local_path = dmaqc_data_dir)}
\CommentTok{# download_bucket_files_to_local_dir(bucket = paste(bucket,"1-Data_Dictionary/",sep=""),}
\CommentTok{#                                    local_path = dmaqc_dict_dir)}
...
\NormalTok{  tmp_dict_data =}\StringTok{ }\NormalTok{dict_data[[}\KeywordTok{which}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(currname,}\KeywordTok{names}\NormalTok{(dict_data)))]]}
  \CommentTok{# print(tmp_dict_data[grepl("pid",tmp_dict_data[,1]),1])}
