...
merged_g = igraph::graph_from_edgelist(merged_net)
...
prop_res = dRWR(merged_g,"none",seeds)
...
geneset = names(which(sex_assoc_genes & weight_assoc_genes))
