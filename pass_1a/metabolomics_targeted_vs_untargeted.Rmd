...
# Change the dataset names (optional)
...
prediction_analysis_results_obj =  load_from_bucket(
  "tar_vs_untar_prediction_analysis_results.RData",
    "gs://bic_data_analysis/pass1a/metabolomics/",F)
prediction_analysis_results =
  prediction_analysis_results_obj$prediction_analysis_results
naive_cov_prediction_analysis_results =
  prediction_analysis_results_obj$naive_cov_prediction_analysis_results
...
for(tissue in names(results_metrics)){
  ...
  tb = table(tissue_summary$dataset,tissue_summary$rhos>0.7)
  print(1 - (tb[,"FALSE"]/rowSums(tb)))
}
